...
run_and_log "python scripts/full_train.py --project_dir ${DATASET_DIR} --extra_training_args '--exposure_lr_init 0.0 --eval' > ${RESULTS_FILE}" "Step 9: Train and Evaluate the Model w/o additional and constraint"
