...
cf.logging.SetBasicConfigIfMain(__name__, logger_name='GAUSSIANS_PREPARE_DATA')
...
def LoadRecordingDetails(recording_details_path, selected_area=None):
...
def PrepareData(
    ...
    if args.directions == '1':
        ...
        face_names = ['f1', 'f2', 'r1', 'r2', 'b1', 'b2', 'l1', 'l2', 'u1', 'u2']
        YAW_PITCH_LUT = { # PACOMMENT: modified
            'f1': (0, 0), 'f2': (315, 0),
            'r1': (270, 0), 'r2': (225, 0),
            'b1': (180, 0), 'b2': (135, 0),
    ...
    for image_id in image_ids:
        ...
        for face_name in face_names:
            ...
            map_x, map_y = ComputeRemapTablesCubicToRectilinear(image_size, image_size, hfov, total_rotations, pitch)
...
if __name__ == "__main__":
    ...
    if args.selected_area:
        recording_details = LoadRecordingDetails(args.recording_details_path, args.selected_area)
    else:
        recording_details = LoadRecordingDetails(args.recording_details_path)
