...
# run_and_log "python ss_utils/generate_colmap_calibration.py --project_dir ${DATASET_DIR}" "Step 1: Generate Colmap Calibration"
...
# run_and_log "python preprocess/generate_chunks.py --project_dir ${DATASET_DIR}" "Step 7: Generate Chunks"
